...
env $(cat "${CLUSTER_DIR}/env.sh") OSDK_FORCE_RUN_MODE=local OVN_IMAGE=quay.io/pliurh/ovn-kubernetes:lm15 ./cluster-network-operator start --kubeconfig "${KUBECONFIG}"
